...
for(i in 1:1000){
  ...
  for(k in seq(1,9,1)){
    ...
    x2a=mvrnorm(n = 100, mu=mu22, Sigma =sg*k)
    x3a=mvrnorm(n = 100, mu=mu33, Sigma =sg*k)
...
write.csv(rrb/1000,"D:\\Working\\NYU Project\\Carole Validation\\New test 20240904\\New Paper Tables\\final_0207\\theta_feature.csv",row.names = F)
